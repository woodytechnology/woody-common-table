...
url=https://api.github.com/repos/woody.vip/woody-common-table/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "woody-common-table更新", "text": "@所有人\n# [woody-common-table]('$html_url')\n'$body'"}}'
